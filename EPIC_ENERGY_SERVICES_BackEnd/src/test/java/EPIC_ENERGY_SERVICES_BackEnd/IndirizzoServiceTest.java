...
public class IndirizzoServiceTest {
    ...
    public void testFindById() throws Exception {
        Indirizzo foundIndirizzo = indirizzoService.findById(indirizzoTest.getId());
        assertNotNull(foundIndirizzo);
        assertEquals(indirizzoTest.getVia(), foundIndirizzo.getVia());
    }

    @Test
    public void findByIdAndDelete() throws Exception {
        Indirizzo foundIndirizzo = indirizzoService.findById(indirizzoTest.getId());
        assertNotNull(foundIndirizzo);
        assertEquals(indirizzoTest.getVia(), foundIndirizzo.getVia());
        indirizzoRepo.delete(foundIndirizzo);
    }
